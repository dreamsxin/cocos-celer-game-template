...
export class Matrix {
   ...
   * @param mOut
   */
  addSelf(m: Matrix): Matrix {
    this.r1.addSelf(m.r1);
    this.r2.addSelf(m.r2);
    return this;
  }
   ...
   * @param mOut
   */
  subtractSelf(m: Matrix): Matrix {
    this.r1.subSelf(m.r1);
    this.r2.subSelf(m.r2);
    return this;
  }
  ...
  multiplySelf(m: Matrix): Matrix {
    this.r1.x = this.r1.x * m.r1.x + this.r1.y * m.r2.x;
    this.r1.y = this.r1.x * m.r1.y + this.r1.y * m.r2.y;
    this.r2.x = this.r2.x * m.r1.x + this.r2.y * m.r2.x;
    this.r2.y = this.r2.x * m.r1.y + this.r2.y * m.r2.y;
  ...
  multiplyNum(n: number, mOut?: Matrix): Matrix {
    ...
    dest.r1 = this.r1.scale(n, dest.r1);
    dest.r2 = this.r2.scale(n, dest.r2);
   ...
   * @param mOut
   */
  multiplyNumSelf(n: number): Matrix {
    this.r1.scaleSelf(n);
    this.r2.scaleSelf(n);
