...
export class TableManager {
  ...
  private load =
    TableManager.JSON_URL && TableManager.JSON_URL != ""
    ...
    this.load(
      ...
      function (err, JsonAsset: cc.JsonAsset) {
        if (err) {
          ...
          let jsonArray =
            JsonAsset.constructor["name"] == "Array"
              ? JsonAsset
              : JsonAsset.json;
  ...
  private loadJson(url) {
    ...
    tableName =
      tableName.charAt(0).toUpperCase() + tableName.slice(1, tableName.length);
    this.load(
      TableManager.JSON_URL + url + this.fileFormat,
      function (err, JsonAsset: cc.JsonAsset) {
        if (err) {
          console.error(err.errorMessage);
        } else {
  ...
  public getAnimals(key: string | number): Animals {
    if (this.Animals[key]) {
      ...
      console.error("Animals 不存key：" + key);
      return null;
    }
  }
  ...
  public getAnimals_en(key: string | number): Animals_en {
    if (this.Animals_en[key]) {
      ...
      console.error("Animals_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getBall_en(key: string | number): Ball_en {
    if (this.Ball_en[key]) {
      ...
      console.error("Ball_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getBooks_en(key: string | number): Books_en {
    if (this.Books_en[key]) {
      ...
      console.error("Books_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getBuildings(key: string | number): Buildings {
    if (this.Buildings[key]) {
      ...
      console.error("Buildings 不存key：" + key);
      return null;
    }
  }
  ...
  public getBuildings_en(key: string | number): Buildings_en {
    if (this.Buildings_en[key]) {
      ...
      console.error("Buildings_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getFood_en(key: string | number): Food_en {
    if (this.Food_en[key]) {
      ...
      console.error("Food_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getFruits_en(key: string | number): Fruits_en {
    if (this.Fruits_en[key]) {
      ...
      console.error("Fruits_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getMakeup(key: string | number): Makeup {
    if (this.Makeup[key]) {
      ...
      console.error("Makeup 不存key：" + key);
      return null;
    }
  }
  ...
  public getMakeup_en(key: string | number): Makeup_en {
    if (this.Makeup_en[key]) {
      ...
      console.error("Makeup_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getOrnament(key: string | number): Ornament {
    if (this.Ornament[key]) {
      ...
      console.error("Ornament 不存key：" + key);
      return null;
    }
  }
  ...
  public getOrnament_en(key: string | number): Ornament_en {
    if (this.Ornament_en[key]) {
      ...
      console.error("Ornament_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getOther_en(key: string | number): Other_en {
    if (this.Other_en[key]) {
      ...
      console.error("Other_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getOutlet(key: string | number): Outlet {
    if (this.Outlet[key]) {
      ...
      console.error("Outlet 不存key：" + key);
      return null;
    }
  }
  ...
  public getOutlet_en(key: string | number): Outlet_en {
    if (this.Outlet_en[key]) {
      ...
      console.error("Outlet_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getPlants(key: string | number): Plants {
    if (this.Plants[key]) {
      ...
      console.error("Plants 不存key：" + key);
      return null;
    }
  }
  ...
  public getPlants_en(key: string | number): Plants_en {
    if (this.Plants_en[key]) {
      ...
      console.error("Plants_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getRandom(key: string | number): Random {
    if (this.Random[key]) {
      ...
      console.error("Random 不存key：" + key);
      return null;
    }
  }
  ...
  public getShape_en(key: string | number): Shape_en {
    if (this.Shape_en[key]) {
      ...
      console.error("Shape_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getTool_en(key: string | number): Tool_en {
    if (this.Tool_en[key]) {
      ...
      console.error("Tool_en 不存key：" + key);
      return null;
    }
  }
  ...
  public getVegetable(key: string | number): Vegetable {
    if (this.Vegetable[key]) {
      ...
      console.error("Vegetable 不存key：" + key);
      return null;
    }
  }
  ...
  public getVegetable_en(key: string | number): Vegetable_en {
    if (this.Vegetable_en[key]) {
      ...
      console.error("Vegetable_en 不存key：" + key);
      return null;
    }
  }
